...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("bg-primary/10 rounded-[3px]", className)}
    {...props}
  />
));
...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "p-3 text-left align-middle font-medium  text-xs  text-default-900    capitalize  [&:has([role=checkbox])]:pr-0 bg-primary/20 dark:bg-[#33445B]",
      className
    )}
    {...props}
  />
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-3 align-middle  text-xs text-default-900  font-normal  [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
