...
const data = [
  {
    ...
    isProgress: true,
    color: "primary",
    icon: <SafeIcon icon="heroicons:chart-pie" className="w-6 h-6" />
  },
  {
    id: 2,
    ...
    isProgress: true,
    color: "success",
    icon: <SafeIcon icon="heroicons:check-circle" className="w-6 h-6" />
  },
  {
    id: 3,
    name: "In Progress",
    ...
    isProgress: false,
    color: "destructive",
    icon: <SafeIcon icon="heroicons:clock" className="w-6 h-6" />
  },
]
const Stats = () => {
  return (
