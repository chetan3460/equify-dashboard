...
// import { updateTaskAction } from "@/action/project-action"; // Removed - API actions deleted
...
const AssignTags = ({ task, taskId }) => {
  ...
  const handleSelect = async (value) => {
    ...
    try {
      // await updateTaskAction(taskId, newVal); // API call removed
    } catch (error) {
      console.log(error);
    }
  };
